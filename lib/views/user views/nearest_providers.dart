...
class NearestProvidersPage extends StatelessWidget {
  final List<Provider> providers = [
    Provider(
        id: '1',
        name: 'اسامة ناصر',
        location: const LatLng(24.7136, 46.6753), // King Fahd Road
        status: 'متاح',
        carTransporterSizes: ['صغيرة', 'متوسطة']),
    Provider(
      id: '2',
      name: 'ماجد الحمدي',
      location: const LatLng(24.6911, 46.6845), // Al Olaya District
      status: 'متاح',
      carTransporterSizes: ['كبيرة'],
    ),
  ];
