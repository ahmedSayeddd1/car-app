  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Padding(
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start, // Align text and dropdown to the left
          children: [
            // Title Text
            Text(
            ...
            const SizedBox(height: 16), // Reduced spacing for better hierarchy

            // Decorated Dropdown
            Container(
              decoration: BoxDecoration(
                color: Colors.grey[100], // Background color of the dropdown container
                ...
                child: Obx(
                    ...
                    icon: const Icon(Icons.arrow_drop_down, color: Color.fromARGB(255, 172, 62, 54)), // Custom dropdown icon
                    iconSize: 30, // Icon size
                    iconEnabledColor: const Color.fromARGB(255, 172, 62, 54), // Icon color
                    ...
                    hint: Text(
                      'Select account type'.tr, // Hint text when no value is selected
                      style: const TextStyle(
